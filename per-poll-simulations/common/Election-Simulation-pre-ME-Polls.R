...
Candidate17.df <- read_csv("../common/Candidate 17 DataFrame INCOMPLETE.csv")
...
StoreCand.df <- read_csv("../common/Store Cand INCOMPLETE.csv")
StoreMECand.df <- read_csv("../common/Store ME Cand INCOMPLETE.csv")
